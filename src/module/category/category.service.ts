...
export class CategoryService {
  ...
  async createCategory(payload: createCategoryDTO) {
    try {
      ...
      if (payload?.parentId) {
        ...
        const checkiscategoryispresent = await this.findCategoryByCondition(
          categorypresentCondition,
          select,
        );
        ...
        console.log(select);
        const checkissubcategoryispresent = await this.findCategoryByCondition(
          condition,
          select,
        );
  ...
  async fetchAllActiveCategory() {
    try {
      ...
      return {
        status: true,
        message: 'all active categories fetch successfully',
        data: ActiveCategory,
      };
    } catch (error) {
      console.log(error.message);
